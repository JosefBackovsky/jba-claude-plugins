---
description: Quick commit workflow that stages and commits changes with a clean, short commit message. Use this skill whenever the user asks to commit, make a commit, save changes, or says /commit.
